          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <?php if(Auth::user()->role_id != 5): ?>
                <!--<li class="nav-item"> -->
                <!--    <a class="dropdown-item" href="<?php echo e(url('read_me')); ?>" target="_blank" data-toggle="tooltip" title="<?php echo e(__('Help')); ?>"><i class="dripicons-information"></i></a>-->
                <!--</li>-->
                <?php endif; ?>
                <li class="nav-item">
...
</html><?php /**PATH /home/u623654606/domains/betnaapp.com/public_html/cleversale/resources/views/layout/main.blade.php ENDPATH**/ ?>