      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><span>Motaweron</span><strong class="text-primary">Dashboard</strong></div>
          ...
          <div class="copyrights text-center">
            <p>Design by <a href="http://motaweron.com" class="external">motaweron</a></p>
